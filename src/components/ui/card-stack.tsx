...
export default function CardStack() {
  const initialCards: Card[] = [
    ...
    },
    {
      ...
      title: "Tracks",
      description:
        "Create innovative and open-source solutions that push the boundaries of technology. Collaborate, share ideas, and build projects that drive progress in the decentralized ecosystem.",
    },
  ];
  ...
  return (
    <div
      className={`w-full min-h-screen flex flex-col items-center justify-start bg-background text-foreground transition-all duration-500 relative overflow-hidden pt-24 pb-32`}
    >
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-card border-2 border-primary rounded-lg p-4 flex flex-col justify-between">
                    <div>
                      <p
                        className={`text-xs font-semibold uppercase tracking-widest mb-2 ${currentTheme.trackLabel}`}
                      >
                        {track}
                      </p>
                    </div>
